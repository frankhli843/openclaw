...
describe("deliverDiscordReply", () => {
  ...
  beforeEach(() => {
    ...
    dnrMocks.enforceDiscordDnrWindow.mockReset();
    dnrMocks.enqueueDelivery.mockReset().mockResolvedValue("mock-queue-id");
  ...
  it("returns dnrSuppressed when Discord DNR is active and defers queued delivery", async () => {
