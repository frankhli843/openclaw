...
// frankclaw: gateMode, session-existence fallback, and webhook-relay extensions
import {
...
export async function preflightDiscordMessage(
  ...
  // frankclaw: extend isBoundThreadSession with session-existence fallback (recovers
  // bindings after gateway restart) and bypass mention requirement when a configured
  // binding is in play.
  ...
  const mentionDecision = gateModeApproved
    ? {
  ...
  // frankclaw: gateMode approval bypasses legacy mention drop; require botId before dropping
