...
// frankclaw: [Doramon note to self] prefix detection + behavior overlay
...
// frankclaw: scoped prompt injections for specific channels/threads/groups.
...
export async function runPreparedReply(
  ...
  // frankclaw: prepend note-to-self and scoped prompt blocks when set.
  if (noteToSelfBlock || scopedPromptBlock) {
    prefixedBodyBase = [noteToSelfBlock, scopedPromptBlock, prefixedBodyBase]
      .filter(Boolean)
      .join("\n\n");
  }
