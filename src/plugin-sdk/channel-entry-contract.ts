...
// frankclaw: nodeRequire used as ESM-interop fallback in loadBundledEntryExportSync.
...
function loadBundledEntryModuleSync(
  ...
  // frankclaw: Prefer nodeRequire for dist/ bundles on ALL platforms.
  // Jiti's Proxy-based ESM shim fails on chunked re-exports.
